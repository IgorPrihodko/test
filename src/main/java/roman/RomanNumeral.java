...
public class RomanNumeral {
    ...
    public RomanNumeral(int arabic) {
        ...
        if (arabic < 1)
            throw new NumberFormatException("Value of roman.RomanNumeral must be positive.");
        if (arabic > 3999)
            throw new NumberFormatException("Value of roman.RomanNumeral must be 3999 or less.");
        num = arabic;
    }
